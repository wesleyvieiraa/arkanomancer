import { Autocomplete, FormControlLabel, Grid, Switch } from "@mui/material";
                  ...
                  <Form id={formId} autoComplete="off">
                    ...
                    <MDBox mt={3}>
                      <Autocomplete
                        ...
                        value={
                          optionsExecution.find((option) => option.id === values.executionId) ||
                          null
                        }
                    ...
                    <MDBox mt={3}>
                      <Autocomplete
                        ...
                        getOptionLabel={(option) => option.label}
                        value={
                          optionsDuration.find((option) => option.id === values.durationId) || null
                        }
                        onChange={(event, value) => {
                    ...
                    <MDBox mt={3}>
                      <Autocomplete
                        ...
                        getOptionLabel={(option) => option.label}
                        value={
                          optionsResistance.find((option) => option.id === values.resistanceId) ||
                          null
                        }
                        onChange={(event, value) => {
